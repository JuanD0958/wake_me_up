...
public class MainActivity extends AppCompatActivity
    ...
    protected void onStart() {
        ...
        if (!Utilities.checkPermissions(this)) {
            Utilities.requestPermissions(TAG, this, R.string.permission_rationale);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == Utilities.REQUEST_PERMISSIONS_REQUEST_CODE) {
            if (grantResults.length <= 0) {
                ...
                Utilities.showSnackbar(R.string.permission_denied_explanation, R.string.settings,
    ...
    @Override
    public void showAlarmInMap(AlarmGeofence alarm) {
